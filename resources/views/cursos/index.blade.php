...
<x-app-layout>
    ...
    <div class="container pt-4">
            ...
            <table class="table">
                ...
                <tbody>
                    @foreach ($cursos as $curso)       
                        <tr>
                            <th>
                                <a onclick="cargarOperacion('{{ $curso->id }}', 'show')" class="btn btn-primary"><i class="bi bi-search"></i></a>
                                <a onclick="cargarOperacion('{{ $curso->id }}', 'edit')" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
                                <a onclick="cargarOperacion('{{ $curso->id }}', 'destroy')" class="btn btn-danger"><i class="bi bi-trash"></i></a>                            </th>
                            <td>{{ $titulo[trim($curso->titulo)] ?? 'Error con la clave: ['.$curso->titulo.']' }}</td>
        ...
        <button type="button" class="btn btn-primary mt-3" onclick="cargarOperacion('', 'create')">Nuevo Curso</button>
        @else
